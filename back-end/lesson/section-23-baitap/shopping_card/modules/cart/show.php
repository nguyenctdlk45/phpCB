...
<div id="main-content-wp" class="cart-page">
    ...
    <div id="wrapper" class="wp-inner clearfix">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" data-id="<?php echo $item['id']; ?>" name="qty[<?php echo $item['id']; ?>]" value="<?php echo $item['qty'] ?>" class="num-order">
                                        </td>
        ...
        <?php
        } else echo "Không có sản phẩm nào trong giỏ hàng";
        ?>
